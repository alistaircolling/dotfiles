...
Restate the **last message** in plain, everyday language — like explaining it to a smart friend who doesn't work in tech.
...
"Last message" = the most recent substantive turn in the conversation — usually the previous assistant reply. If it's the user's own message that needs translating, restate that instead.
