-- Blueprint glass — same palette as blueprint; transparent editor over semi-transparent WezTerm.
...
vim.g.colors_name = 'blueprint-glass'
...
hi('CursorLineNr', { fg = accent, bg = bg_line, blend = 22, bold = true })
hi('CursorLine', { bg = bg_line, blend = 22 })
hi('CursorColumn', { bg = bg_line, blend = 22 })
hi('ColorColumn', { bg = bg_line, blend = 22 })
hi('VertSplit', { fg = '#344a5f' })
hi('WinSeparator', { fg = '#344a5f' })
...
hi('MatchParen', { fg = accent, bg = sel, blend = 12, bold = true })
...
hi('PmenuSel', { fg = bg, bg = mint, blend = 10, bold = true })
...
hi('GitSignsAdd', { fg = string_c })
hi('GitSignsChange', { fg = warn })
...
hi('TelescopeBorder', { fg = '#344a5f' })
hi('TelescopePromptNormal', { fg = fg, bg = bg_alt, blend = 18 })
hi('TelescopePromptBorder', { fg = mint, bg = bg_alt, blend = 18 })
